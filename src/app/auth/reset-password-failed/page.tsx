        ...
        <AnimatePresence>
            <div className="flex gap-4 lg:gap-8 flex-col">
                <div className="flex items-center justify-center">
                    <img src="/icons/error.svg" alt="check" />
                </div>
                <div className="flex flex-col gap-2">
                    <h1 className="text-4xl font-bold text-center">Password Reset Failed</h1>
                    <p className="text-sm text-gray-300 leading-relaxed text-center">Password rest failed, proceed to verify again</p>
                </div>

                <Link href="/auth/reset-password" className="w-full text-center bg-white transition-all duration-300 z-0 whitespace-nowrap hover:bg-white/90 rounded-[8px] py-3 px-5 text-[#00246B] font-bold text-[16px]">
                    Reset Password
                </Link>
